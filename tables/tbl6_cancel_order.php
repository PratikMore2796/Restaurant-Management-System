        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Cancel Order of Table
                        Number 006</div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl6);?> <form
                            action="../resadmin/Cancel_order.php" method="post" style="padding: 10px"> <label
                                for="tableid">Table ID:</label> <input class="form-control" type="text" name="tableid"
                                ...
                                Number:</label> <input class="form-control" type="text" name="tableno"
                                value="<?php echo $_SESSION['tbl_number'];?>" id="tblid"> <label for="btiming">Booked
                                Timing:</label> <input class="form-control" type="text" name="b-timing"
                                value="<?php echo $_SESSION['booked_timing'];?>" id="tblid"><br> <input type="submit"

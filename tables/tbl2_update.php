<?php require_once('../resadmin/Auth.php');require_once ('../resadmin/connection.php');require_once ('../resadmin/admin_fun.php');?><?php $tbl1 = "1";$tbl2 = "2";$tbl3 = "3";$tbl4 = "4";$tbl5 = "5";$tbl6 = "6";$tbl7 = "7";$tbl8 = "8";$tbl9 = "9";$tbl10 = "10";?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Update Table Number 002
                    </div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl2);?> <form
                            action="../resadmin/booktbl.php" method="post" style="padding: 10px"> <label
                                for="tableid">Table ID:</label> <input type="text" name="tableid"
                                value="<?php echo $_SESSION['tbl_id'];?>" class="form-control" id="tblid"> <label
                                for="tableid">User ID:</label> <input type="text" name="userid"
                                value="<?php get_userid_details($tbl1); echo $_SESSION['user_id'];?>"
                                class="form-control" id="tblid"> <label for="tableno">Table Number:</label> <input
                                type="text" name="tableno" value="<?php echo $_SESSION['tbl_number'];?>"
                                class="form-control" id="tblid"> <label for="btiming">Booked Timing:</label> <input
                                type="date" name="date" class="form-control" id="date"><br> <input type="time"
                                name="time" class="form-control" id="time"><br> <input type="submit" name="submit"
                                value="Book Now" class="btn btn-primary"> </form>
                    </div>

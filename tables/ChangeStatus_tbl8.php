        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Change Status Table 008
                    </div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl8);?> <form
                            action="../resadmin/changeStatus.php" method="post" style="padding: 10px"> <label
                                ...
                                value="<?php echo $_SESSION['res_timing'];?>" id="tblid" class="form-control"> <label
                                for="btiming">Current Table Status:</label> <input type="text" class="form-control"
                                value="<?php echo $_SESSION['tbl_status'];?>" id="tblstatus"> <label
                                for="change_status">Change Status To:</label> <select id="table_status" name="tblstatus"
                                class="form-control">

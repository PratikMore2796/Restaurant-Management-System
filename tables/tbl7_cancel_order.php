            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Cancel Order Of Table
                        Number 007</div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl7);?> <form
                            action="../resadmin/Cancel_order.php" method="post" style="padding: 10px"> <label
                                ...
                                value="<?php echo $_SESSION['user_id'];?>" id="tblid" class="form-control"> <label
                                for="tableno">Table Number:</label> <input type="text" name="tableno"
                                value="<?php echo $_SESSION['tbl_number'];?>" id="tblid" class="form-control"> <label
                                for="btiming">Booked Timing:</label> <input type="text" class="form-control"
                                name="b-timing" value="<?php echo $_SESSION['booked_timing'];?>" id="tblid"><br> <input
                                type="submit" name="submit" value="Cancle Order" class="btn btn-primary"> </form>
                    </div>
                </div>
            </div>

        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Table Number 008</div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl8);?> <form
                            action="../resadmin/booktbl.php" method="post" style="padding: 10px"> <label
                                ...
                                type="text" name="tableno" value="<?php echo $_SESSION['tbl_number'];?>" id="tblid"
                                class="form-control"><br> <input type="submit" name="submit" value="Book Now"

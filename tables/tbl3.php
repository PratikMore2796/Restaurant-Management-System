        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Table Number 003</div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl3);?> <form
                            action="../resadmin/booktbl.php" method="post" style="padding: 10px"> <label
                                ...
                                for="tableid">User ID:</label> <input type="text" name="userid" class="form-control"
                                ...
                                id="tblid"><br> <label for="tableno">Table Number:</label> <input type="text"
                                name="tableno" value="<?php echo $_SESSION['tbl_number'];?>" class="form-control"
                                id="tblid"><br> <input type="submit" name="submit" value="Book Now"

        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Cancel Table Number 4 Order
                    </div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl4);?> <form
                            action="../resadmin/Cancel_order.php" method="post" style="padding: 10px"> <label
                                ...
                                for="tableid">User ID:</label> <input type="text" class="form-control" name="userid"
                                value="<?php echo $_SESSION['user_id'];?>" id="tblid"> <label for="tableno">Table
                                Number:</label> <input type="text" class="form-control" name="tableno"
                                value="<?php echo $_SESSION['tbl_number'];?>" id="tblid"> <label for="btiming">Booked
                                Timing:</label> <input type="text" class="form-control" name="b-timing"

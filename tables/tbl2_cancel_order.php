    ...
    <div class="wrapper">
        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="col">
                ...
                <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Cancel Order Table Number 002
                </div>
                <div class="row"> <?php get_table_details($tbl2);?> <form action="../resadmin/Cancel_order.php"
                        method="post" style="padding: 10px"> <label for="tableid">Table ID:</label> <input type="text"
                            class="form-control" name="tableid" value="<?php echo $_SESSION['tbl_id'];?>" id="tblid">
                        <label for="tableid">User ID:</label> <input type="text" class="form-control" name="userid"
                            value="<?php echo $_SESSION['user_id'];?>" id="tblid"> <label for="tableno">Table
                            Number:</label> <input type="text" name="tableno" class="form-control"
                            value="<?php echo $_SESSION['tbl_number'];?>" id="tblid"> <label for="btiming">Booked
                            Timing:</label> <input type="text" name="b-timing" class="form-control"
                            value="<?php echo $_SESSION['booked_timing'];?>" id="tblid"><br><br> <input type="submit"
                            name="submit" value="Cancle Order" class="btn btn-primary"> </form>
                </div>

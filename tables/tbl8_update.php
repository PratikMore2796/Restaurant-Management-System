        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Update Table Number 008
                    </div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl8);?> <form
                            action="../resadmin/booktbl.php" method="post" style="padding: 10px"> <label
                                ...
                                value="<?php get_userid_details($tbl1); echo $_SESSION['user_id'];?>" id="tblid"
                                class="form-control"> <label for="tableno">Table Number:</label> <input type="text"
                                name="tableno" value="<?php echo $_SESSION['tbl_number'];?>" id="tblid"
                                class="form-control"> <input type="date" name="date" class="form-control" id="date"><br>
                            <input type="time" name="time" class="form-control" id="time"><br> <input type="submit"

        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Table Number 004</div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl4);?> <form
                            action="../resadmin/booktbl.php" method="post" style="padding: 10px"> <label
                                ...
                                id="tblid"> <label for="tableno">Table Number:</label> <input type="text"
                                class="form-control" name="tableno" value="<?php echo $_SESSION['tbl_number'];?>"

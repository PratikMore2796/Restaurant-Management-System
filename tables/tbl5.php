        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Table Number 005</div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl5);?> <form
                            action="../resadmin/booktbl.php" method="post" style="padding: 10px"> <label
                                for="tableid">Table ID:</label> <input type="text" name="tableid"
                                value="<?php echo $_SESSION['tbl_id'];?>" id="tblid" class="form-control"> <label
                                for="tableid">User ID:</label> <input type="text" name="userid"
                                value="<?php                           try{                               get_userid_details();                               echo $_SESSION['user_id'];                           }                           catch(Exception $e)                           {                               echo 'Please enter user details first'.$e->getMessage();                           }                           ?>"
                                id="tblid" class="form-control"> <label for="tableno">Table Number:</label> <input
                                type="text" class="form-control" name="tableno"
                                value="<?php echo $_SESSION['tbl_number'];?>" id="tblid"><br> <input type="submit"
                                name="submit" value="Book Now" class="btn btn-primary"> </form>
                    </div>
                </div>
            </div>

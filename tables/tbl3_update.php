        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Update Table Number 003
                    </div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl3);?> <form
                            action="../resadmin/booktbl.php" method="post" style="padding: 10px"> <label
                                ...
                                class="form-control" value="<?php echo $_SESSION['tbl_number'];?>" id="tblid"> <input

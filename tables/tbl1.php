...
require_once('../resadmin/admin_fun.php');?><?php 
$tbl1 = "1";
$tbl2 = "2";
$tbl3 = "3";
$tbl4 = "4";
        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding: 10px;font-size: 24px; margin-top: 20px">Table Number 001</div>
                    <div class="row" style="padding-left: 10px"> <?php get_table_details($tbl1);?> <form
                            action="../resadmin/booktbl.php" method="post" style="padding: 10px"> <label
                                ...
                                name="tableno" class="form-control" value="<?php echo $_SESSION['tbl_number'];?>"

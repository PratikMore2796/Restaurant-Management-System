        ...
        <div class="container-fluid" style="padding: 10px">
            <div class="row">
                <div class="col">
                    ...
                    <div class="row" style="padding-left: 20px;font-size: 24px; margin-top: 20px">Change Status Table
                        Number 007</div>
                    <div class="row" style="padding-left: 20px"> <?php get_table_details($tbl7);?> <form

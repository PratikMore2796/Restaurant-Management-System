...
{
    echo "<div class='container' id='tbl1_readyf' 
...
{
    echo "<div class='container' id='tbl1_preparingf' onclick='tbl1_preparing()'
...
{
    echo "<div class='container' id='tbl1_emptyf' onclick='tbl1_empty()'
...
{
    echo "<div class='container' id='tbl2_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl2_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 002</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl2_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 002</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl2_emptyf'
                     style='background-color: #FFFFFF;
                         text-align: center;
                         border: 2px #000000 solid;
                         width: 40%;cursor: pointer'><h2>Table 002</h2>
...
{
    echo "<div class='container' id='tbl3_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl3_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 003</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl3_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 003</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl4_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl4_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 004</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl4_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 004</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl4_emptyf'
                     style='background-color: #FFFFFF;
                         text-align: center;
                         border: 2px #000000 solid;
                         width: 40%;cursor: pointer'><h2>Table 004</h2>
...
{
    echo "<div class='container' id='tbl5_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl5_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 005</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl5_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 005</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl5_emptyf'
                     style='background-color: #FFFFFF;
                         text-align: center;
                         border: 2px #000000 solid;
                         width: 40%;cursor: pointer'><h2>Table 005</h2>
...
{
    echo "<div class='container' id='tbl6_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl6_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 006</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl6_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 006</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl6_emptyf'
                     style='background-color: #FFFFFF;
                         text-align: center;
                         border: 2px #000000 solid;
                         width: 40%;cursor: pointer'><h2>Table 006</h2>
...
{
    echo "<div class='container' id='tbl7_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl7_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 007</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl7_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 007</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl7_emptyf'
                     style='background-color: #FFFFFF;
                         text-align: center;
                         border: 2px #000000 solid;
                         width: 40%;cursor: pointer'><h2>Table 007</h2>
...
{
    echo "<div class='container' id='tbl8_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl8_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 008</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl8_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 008</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl8_emptyf'
                     style='background-color: #FFFFFF;
                         text-align: center;
                         border: 2px #000000 solid;
                         width: 40%;cursor: pointer'><h2>Table 008</h2>
...
{
    echo "<div class='container' id='tbl9_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl9_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 009</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl9_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 009</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl9_emptyf'
                     style='background-color: #FFFFFF;
                         text-align: center;
                         border: 2px #000000 solid;
                         width: 40%;cursor: pointer'><h2>Table 009</h2>
...
{
    echo "<div class='container' id='tbl10_bookedf'
                     style='background-color: red;
                         text-align: center;
...
{
    echo "<div class='container' id='tbl10_readyf'
                     style='background-color: grey;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 0010</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl10_preparingf'
                     style='background-color: green;
                         text-align: center;
                         width: 40%;cursor: pointer'><h2>Table 0010</h2>
                    <h3> ".$tbl_number."</h3><br>"
...
{
    echo "<div class='container' id='tbl10_emptyf'
                     style='background-color: #FFFFFF;
                         text-align: center;
                         border: 2px #000000 solid;
                         width: 40%;cursor: pointer'><h2>Table 0010</h2>
